...
class TestBooksCollector:
    ...
    @pytest.mark.parametrize('new_book, book_genre', [['Анна Каренина', 'Ужасы'], ['После бала', 'Детективы'], ['Детство, отрочество, юность', 'Ужасы']])
    def test_get_books_with_specific_genre_two_books_for_one_genre(self, new_book, book_genre):
        ...
        assert collector.get_books_with_specific_genre('Ужасы') == ['Анна Каренина', 'Детство, отрочество, юность']

    def test_get_books_genre_current(self):
        collector = BooksCollector()

        assert collector.get_books_genre() == ['Фантастика', 'Ужасы', 'Детективы', 'Мультфильмы', 'Комедии']

    @pytest.mark.parametrize('new_book, book_genre', [['Гарри Поттер', 'Фантастика'], ['Хэллоуин', 'Ужасы'], ['Розовая пантера', 'Детективы'], ['Три поросенка', 'Мультфильмы'], ['Один дома', 'Комедии']])
    def test_get_books_for_children_three_books_out_of_five_are_ok_for_children(self, new_book, book_genre):
        ...
        assert collector.get_books_for_children() == ['Гарри Поттер', 'Три поросенка', 'Один дома']
    ...
    def test_add_book_in_favorites_one_book(self):
        ...
        assert 'Три поросенка' in collector.favorites()
    ...
    def test_delete_book_from_favorites_one_book(self):
        ...
        assert 'Три поросенка' not in collector.favorites()
    ...
    def test_get_list_of_favorites_books_two_books_of_three_are_favorite(self):
        ...
        assert collector.favorites() == ['Гарри Поттер', 'Три поросенка']
